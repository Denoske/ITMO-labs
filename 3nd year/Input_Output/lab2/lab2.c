...
{
	{
		...
		start_cyl: 0x0,
		part_type: 0x83,
		end_head: head4size(0x4FFF),
		end_sec: sec4size(0x4FFF),
		end_cyl: 0x9F,
		abs_start_sec: 0x1,
		sec_in_part: 0x5FFF // 12Mbyte
	},
	{
		boot_type: 0x00,
		start_head: head4size(0x6000),
		start_sec: sec4size(0x6000),
		start_cyl: 0x0,
		part_type: 0x05, // extended partition type
		end_sec: sec4size(0x18FFF),
...
static unsigned int def_log_part_br_abs_start_sector[] = {0x6000, 0xD800};
	...
	{
		{
			...
			start_cyl: 0x0, 
			part_type: 0x83,
			end_head: head4size(0xD7FF),
			end_sec: head4size(0xD7FF),
			end_cyl: 0x9F,
			abs_start_sec: 0x1,
			sec_in_part: 0x77FF  //15Mbyte
		},
		{
			boot_type: 0x00,
			start_head: head4size(0xD800),
			start_sec: sec4size(0xD800),
			start_cyl: 0x00,
			part_type: 0x05,
			end_head: head4size(0x18FFF),
			end_sec: sec4size(0x18FFF),
